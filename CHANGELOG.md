...
## [2.17.8] (Fennec) - 2025-12-26

### Fixed
- **Layer switcher dropdown z-index** - added z-index to container level (1001 vs 1000 for ruler)
...
### Fixed
- **Layer switcher dropdown z-index** - dropdown now appears above ruler button (attempt 1)
